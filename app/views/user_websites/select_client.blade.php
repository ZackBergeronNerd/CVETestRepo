...
@section('title')
  Find a client to send {{ $user_website->website->name }}
@stop
  ...
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading">
        <div class="row">
          <div class="col-md-9">
            <h3 class="no-margin-top">Find a client to send {{ $user_website->website->name }}</h3>
          </div>
          <div class="col-md-3">
          ...
          <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
            ...
            <tbody>
              ...
              <tr data-id="{{ $user_client->client->id }}">
                <td style="width:10%">
                  <a href="/clients/{{ $user_client->client->id }}/send_website/{{ $user_website->id }}" class="btn btn-sm btn-primary">
